...
export const rental = $root.rental = (() => {
    ...
    rental.v1 = (function() {
        ...
        v1.LocationStatus = (function() {
             ...
             * @property {string|null} [pointName] LocationStatus pointName
            ...
            /**
             * LocationStatus pointName.
             * @member {string} pointName
             * @memberof rental.v1.LocationStatus
             * @instance
             */
            LocationStatus.prototype.pointName = "";
            ...
            LocationStatus.fromObject = function fromObject(object) {
                ...
                if (object.pointName != null)
                    message.pointName = String(object.pointName);
            ...
            LocationStatus.toObject = function toObject(message, options) {
                ...
                if (message.pointName != null && message.hasOwnProperty("pointName"))
                    object.pointName = message.pointName;
        ...
        v1.Identity = (function() {
             ...
             * @memberof rental.v1
             * @interface IIdentity
             * @property {string|null} [licenseNumber] Identity licenseNumber
             * @property {string|null} [name] Identity name
             * @property {rental.v1.Gender|null} [gender] Identity gender
             * @property {number|null} [dateOfBirthMs] Identity dateOfBirthMs
             */
             ...
             * @instance
             */
            Identity.prototype.licenseNumber = "";
            ...
            /**
             * Identity dateOfBirthMs.
             * @member {number} dateOfBirthMs
             * @memberof rental.v1.Identity
             * @instance
             */
            Identity.prototype.dateOfBirthMs = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
            ...
            Identity.fromObject = function fromObject(object) {
                ...
                if (object.licenseNumber != null)
                    message.licenseNumber = String(object.licenseNumber);
                if (object.name != null)
                ...
                if (object.dateOfBirthMs != null)
                    if ($util.Long)
                        (message.dateOfBirthMs = $util.Long.fromValue(object.dateOfBirthMs)).unsigned = false;
                    else if (typeof object.dateOfBirthMs === "string")
                        message.dateOfBirthMs = parseInt(object.dateOfBirthMs, 10);
                    else if (typeof object.dateOfBirthMs === "number")
                        message.dateOfBirthMs = object.dateOfBirthMs;
                    else if (typeof object.dateOfBirthMs === "object")
                        message.dateOfBirthMs = new $util.LongBits(object.dateOfBirthMs.low >>> 0, object.dateOfBirthMs.high >>> 0).toNumber();
                return message;
            };
            ...
            Identity.toObject = function toObject(message, options) {
                ...
                if (options.defaults) {
                    ...
                    if ($util.Long) {
                        let long = new $util.Long(0, 0, false);
                        object.dateOfBirthMs = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                    } else
                        object.dateOfBirthMs = options.longs === String ? "0" : 0;
                }
                if (message.licenseNumber != null && message.hasOwnProperty("licenseNumber"))
                    object.licenseNumber = message.licenseNumber;
                if (message.name != null && message.hasOwnProperty("name"))
                    object.name = message.name;
                if (message.gender != null && message.hasOwnProperty("gender"))
                    object.gender = options.enums === String ? $root.rental.v1.Gender[message.gender] : message.gender;
                if (message.dateOfBirthMs != null && message.hasOwnProperty("dateOfBirthMs"))
                    if (typeof message.dateOfBirthMs === "number")
                        object.dateOfBirthMs = options.longs === String ? String(message.dateOfBirthMs) : message.dateOfBirthMs;
                    else
                        object.dateOfBirthMs = options.longs === String ? $util.Long.prototype.toString.call(message.dateOfBirthMs) : options.longs === Number ? new $util.LongBits(message.dateOfBirthMs.low >>> 0, message.dateOfBirthMs.high >>> 0).toNumber() : message.dateOfBirthMs;
                return object;
            };
